...
public class JcohyAsciidoctorPlugins implements Plugin<Project> {
    ...
    private void addAsciidoctorTaskAttributes(Project project,Map<String, Object> attributes) {
        ...
        attributes.put("java-code", project.getRootProject().getProjectDir() + "/src/main/java/com/jcohy/sample/algorithm");
        attributes.put("kotlin-code", project.getRootProject().getProjectDir() + "/src/main/kotlin/com/jcohy/sample/algorithm");
        attributes.put("go-code", project.getRootProject().getProjectDir() + "/src/main/go/com/jcohy/sample/algorithm");
        attributes.put("oss-images", "https://study.jcohy.com/images/algorithm");
    }
}
